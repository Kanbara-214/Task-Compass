...
public class PriorityScoringService {
	...
	public PriorityInsight evaluate(TaskItem task, LocalDate today) {
		...
		String summary = buildSummary(overdue, dueToday, daysUntilDue, task.getImportance(),
				task.getEstimatedMinutes());
		String bandLabel = bandLabel(score);
		String bandClass = bandClass(score, overdue);
		return new PriorityInsight(score, bandLabel, bandClass, summary, List.copyOf(reasons), overdue, dueToday,
				dueThisWeek);
	}
